...
export default function () {
    ...
    function handleClickButton() {
        ...
        localStorage.setItem("app-02", `salvo pelo app-02 ${info}`);

        localStorage.setItem("root-store", `salvo pelo app-02 ${info}`);
    ...
    return (
        <>
            <button onClick={handleClickButton}>app-02</button>
